require.config({
    paths: {
        ...
        'customSlick':PaidPost.assets + "js/lib/customslick",
        'SlotAnimation':PaidPost.assets + "js/lib/slotanimation",

        'tour':PaidPost.assets + "pano_video/tour",
        'panoVideo': PaidPost.assets + "js/lib/panovideo"
    },
    packages: [
...
var G = G || {};
var projectDetails = 'Cartier | A Classic Landmark - ',
